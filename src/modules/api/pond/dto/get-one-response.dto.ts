...
import { GetOneChangingWaterResponseDto } from '@modules/api/manualMonitoring/dto/get-one-changing-water-response.dto';
import { GetOneFatalityResponseDto } from '@modules/api/manualMonitoring/dto/get-one-fatality-response.dto';
import { GetOneFeedingResponseDto } from '@modules/api/manualMonitoring/dto/get-one-feeding-response.dto';
import { GetOneSamplingResponseDto } from '@modules/api/manualMonitoring/dto/get-one-sampling-response.dto';
import { GetOneTransparencyResponseDto } from '@modules/api/manualMonitoring/dto/get-one-transparency-response.dto';
import { GetOneSensorResponseDto } from '@modules/api/sensor/dto';
